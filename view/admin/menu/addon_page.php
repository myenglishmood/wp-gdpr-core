...
<div class="wrap">
    ...
    <div id="wp-gdpr_nav_menu">
        <a id="a_addon" class="wp-gdpr_active_tab" href="<?php echo admin_url( 'admin.php?page=addon' ) ?>"><span
    ...
    <br>
    <div id="user_info" class="wp-gdpr_postbox user_info">
    ...
    <div id="addons_box">
			...
			foreach ( $plugins as $plugin_data ):
				if ( ! empty( $plugin_data['name'] ) ): ?>
                    <div class="wp-gdpr_addon_box">
                        ...
                        <div class="gf_footer wp-gdpr_addon_footer">
							<?php if ( $plugin_data['status'] == 'not-installed' ): ?>
                                <a href="<?php echo $plugin_data['plugin_link'] ?>" target="_blank"
                                   class="button wp-gdpr_not-installed"><span class="dashicons dashicons-cart"></span>&nbsp;Buy
                                    now</a>
							<?php elseif ( $plugin_data['status'] == 'active' ): ?>
                                <a class="button wp-gdpr_active"><span class="dashicons dashicons-controls-repeat"></span>&nbsp;Active</a>
							<?php elseif ( $plugin_data['status'] == 'inactive' ): ?>
                                <a class="button wp-gdpr_in-active"
							...
							<?php endif; ?>
                            <a class="wp-gdpr_more_inf" target="_blank" href="<?php echo $plugin_data['plugin_link'] ?>">More
                                info</a>
                        </div>
                    </div>
				<?php
		...
		?>
        <div class="request_addon wp-gdpr_addon_box">
            ...
            <div class="request_footer wp-gdpr_addon_footer">
                <a class="wp-gdpr_more_inf" href="https://wp-gdpr.eu/add-ons/">Visit the add-on page</a>
            </div>
        </div>
    </div>
</div>

...
<div class="wrap">
    ...
    <p align="center"><img class="wp-gdpr_a_background_img" src="<?php echo GDPR_URL . 'assets/images/logo-trans-bg.png'; ?>"></p>
...
"></span> Available addons</a>
        <a id="a_plugins" class="wp-gdpr_active_tab" href="<?php echo admin_url( 'admin.php?page=addon&page_type=addonlist' ) ?>"><span class="dashicons dashicons-admin-plugins"></span>&nbsp;Your plugins</a>
    ...
    <br>
    <div id="user_info" class="wp-gdpr_postbox postbox user_info">

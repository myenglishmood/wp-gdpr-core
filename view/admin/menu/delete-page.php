...
<div class="wrap">
    ...
    <div id="nav_menu">
        <a id="a_delete" href="<?php echo admin_url('admin.php?page=wp_gdpr&page_type=deleterequest')?>" class="active_tab"><span class="dashicons dashicons-trash"></span>&nbsp;Delete requests</a>

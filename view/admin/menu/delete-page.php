...
<div class="wrap">
    ...
    <div id="nav_menu">
        <a id="a_delete" href="<?php echo admin_url('admin.php?page=deletelist')?>" class="active_tab"><span class="dashicons dashicons-trash"></span>&nbsp;Delete requests</a>
        ...
        <a target="_blank" id="a_addon" href="https://wp-gdpr.eu/add-ons/"><span><img class="a_icon" src="<?php echo GDPR_URL . 'assets/images/bliksem.svg'; ?>" style="width:15px; height=:auto;"></span>&nbsp;Add-ons</a>
    </div>

...
<div class="wrap">
    ...
    <div id="wp-gdpr_nav_menu">
        ...
        <a id="a_datarequest" href="<?php echo admin_url('admin.php?page=wp_gdpr&page_type=datarequest')?>" class="wp-gdpr_active_tab"><span class="dashicons dashicons-search"></span>&nbsp;Data Requests</a>

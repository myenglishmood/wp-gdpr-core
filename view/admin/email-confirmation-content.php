        ...
        <td class="wp-gdpr_container"
            ...
            <div class="content"
                ...
                <span class="preheader"
                      style="color: transparent; display: none; height: 0; max-height: 0; max-width: 0; opacity: 0; overflow: hidden; mso-hide: all; visibility: hidden; width: 0;"><?php _e( 'Request to view your personal data', 'wp_gdpr' ); ?></span>
                <table class="main"
                    ...
                    <tr>
                        <td class="wrapper"
                            ...
                            <table border="0" cellpadding="0" cellspacing="0"
                                ...
                                <tr>
                                    <td style="font-family: sans-serif; font-size: 14px; vertical-align: top;">
                                        <p style="font-family: sans-serif; font-size: 14px; font-weight: normal; margin: 0; Margin-bottom: 15px;"><?php _e( 'List of processed data', 'wp_gdpr' ); ?></p>
                                    </td>
                                </tr>

...
<head>
    ...
    <title>We confirm data deletion</title>
    <style>
        /* -------------------------------------
        ...
        <td class="wp-gdpr_container"
            ...
            <div class="content"
                ...
                <span class="preheader"
                      style="color: transparent; display: none; height: 0; max-height: 0; max-width: 0; opacity: 0; overflow: hidden; mso-hide: all; visibility: hidden; width: 0;"><?php _e( 'Request to delete personal data', 'wp_gdpr' ); ?></span>
                <table class="main"
                                ...
                                <tr>
                                    <td style="font-family: sans-serif; font-size: 14px; vertical-align: top;">
                                        <p style="font-family: sans-serif; font-size: 14px; font-weight: normal; margin: 0; Margin-bottom: 15px;"><?php _e( 'Dear Sir / Madam', 'wp_gdpr' ); ?>
                                            ,</p>
                                        <p style="font-family: sans-serif; font-size: 14px; font-weight: normal; margin: 0; Margin-bottom: 15px;"><?php echo $requested_email . ' ' . __( 'asked to delete his/her personal data.', 'wp_gdpr' ); ?></p>
                                    </td>
                                <tr>
                        ...
                        <tr>
                            <td class="content-block"
                                ...
                                <span class="apple-link" style="color: #999999; font-size: 12px; text-align: center;"><a
                                        href="<?php echo get_home_url(); ?>"><?php echo get_bloginfo( 'name' ); ?></a></span>
                            </td>
                        </tr>
                    </table>
                </div>

...
<form method="post" action="" class="postbox" id="gdpr_admin_privacy_policy">
    <h3><?php _e( 'Settings for', 'wp_gdpr' ); ?>&nbsp;<b><?php _e( 'WordPress comments' ); ?></b>&nbsp;<span
                class="dashicons dashicons-info"></span></h3>
    <hr>
    ...
    <h3><?php _e( 'Settings for', 'wp_gdpr' ); ?> <b><?php _e( 'Personal Data Request Page', 'wp_gdpr' ); ?></b>&nbsp;<small>
            <a href="<?php echo Request_Form::get_personal_data_page_url( '' ) ?>" style="color: #1F87B6;">view page</a>
        </small>&nbsp;<span class="dashicons dashicons-info"></span></h3>
